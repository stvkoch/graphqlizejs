...
function resolvers(sequelize, pubsub) {
  ...
  var resolvers = _objectSpread(_objectSpread({}, Object.keys(sequelize.models).reduce(function (acc, modelName) {
    ...
    var associates = Object.keys(associations).reduce(function (accAssoc, associationName) {
      ...
      if (association.isMultiAssociation) accAssoc["_".concat(associationFieldName, "Count")] = association.target.options.gqMiddleware.queryCount(function (parent, args, context, info) {
  ...
  resolvers.Query = _objectSpread(_objectSpread({}, Object.keys(sequelize.models).reduce(function (acc, modelName) {
    ...
    if (model.gqQueryCount !== false) acc["_".concat(plural, "Count")] = model.options.gqMiddleware.queryCount(function (parent, args, context, info) {
  ...
  resolvers.Mutation = _objectSpread(_objectSpread({}, Object.keys(sequelize.models).reduce(function (acc, modelName) {
    ...
    if (model.gqUpdate !== false) acc['update' + singularUF] = model.options.gqMiddleware.update( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(parent, args, context, info) {
    ...
    if (model.gqDelete !== false) acc['delete' + singularUF] = model.options.gqMiddleware["delete"]( /*#__PURE__*/function () {
