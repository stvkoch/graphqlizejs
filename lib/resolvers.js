...
function resolvers(sequelize, pubsub) {
  ...
  var additionalResolvers = _objectSpread({
    ...
    mutation: {},
    subscription: {}
  }, getAdditionalresolvers(sequelize, pubsub)); //associations
  ...
  resolvers.Mutation = _objectSpread({}, Object.keys(sequelize.models).reduce(function (acc, modelName) {
    ...
    if (model.gqCreate !== false) acc["create" + singularUF] =
    /*#__PURE__*/
    function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                instance = model.create(args.input);
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee2(parent, args, context, info) {
        var updateValues, nwhere, instances, resultDb, result;
    ...
    if (model.gqDelete !== false) acc["delete" + singularUF] =
    /*#__PURE__*/
    function () {
