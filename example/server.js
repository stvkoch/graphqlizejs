...
const schemaGenerated = prettier.format(schema(db.sequelize.models, extend), {
  parser: "graphql"
});

const resolversGenerated = resolvers(db, db => ({
  mutation: {
...
app.get("/schema", (_, res) => res.send(schemaGenerated));
